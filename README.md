...
- 🎓 Amateur developer.
- 🌏 Love exploring new tech trends and contributing to opensource.
- 🤝 Always excited to collaborate and connect with fellow developers.
- 🎧 Enjoyer of music and tech podcasts.
- 🦀 Rust enthusiast
...
|----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| ![](https://skillicons.dev/icons?i=java,rust,py,kotlin,ts,js,html,css&perline=4) | ![](https://skillicons.dev/icons?i=nuxt,bun,mongodb,mysql,redis,linux,git,docker&perline=4) |
